                    ...
                    <div class="header_content d-flex flex-row align-items-center justify-content-start">
                        ...
                        <nav class="main_nav_contaner ml-auto">
                            <ul class="main_nav">
                                ...
                                <button style="padding:10px;" class="custom-button">Donate Now</button>
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                        <a style="font-weight:bold;color:black;"  class="dropdown-item" href="/student-dashboard">Account Dashboard</a>
                                        <a style="font-weight:bold;color:black;"  class="dropdown-item" href="/course-dashboard">Course Dashboard</a>

                                        <form class="text-center" action="/logout" method="post">
                                            @csrf
                                           <button style="font-size:14px;font-weight:bold;" class="dropdown-item" type="submit"> <i class="fa fa-sign-out"></i> Sign out</button>
                                        </form>
