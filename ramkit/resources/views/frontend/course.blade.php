                        ...
                        <div class="row courses_row">
                            ...
                            @foreach ($courses as $course)
                                <div class="col-lg-6 course_col">
                                    <div class="course">
                                        <div class="course_image" style="height: 200px; overflow: hidden;"><img
                                                style="width: 100%; height: auto; object-fit: cover;"
                                                src="{{ asset('/storage/' . $course->img_1) }}" alt=""></div>
                                        <div class="course_body">
                                            <div class="d-flex justify-content-between">
                                                <h5 class="course_title"><a href="">{{ $course->title }}</a></h5>
                                            ...
                                            <div class="course_teacher" style="color: darkblue;"> {{ $course->type }} course </div>
                                            <div class="course_text">
                                                <p>{{ Str::limit($course->subtitle, 60) }} </p>
                                            </div>
                                        ...
                                        <div class="course_footer">
                                            <div
                                                ...
                                                <div class="course_info">
                                                    <span style="text-decoration: line-through;">{{ $course->price }}
                                                        Taka/-</span>
                                                </div>
                                                <div class="course_info">
                                                    <span>{{ $course->price_a }} Taka/-</span>
                                                </div>

                                                <div class="course_price ml-auto"><button type="submit" class="btn btn-default" style="background:#14bdee; color:white;"><i class="fa fa-plus"></i> Enroll</button></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col">
                                <div class="pagination_container d-flex flex-row align-items-center justify-content-start">
                                    ...
                                    <div class="courses_show_container ml-auto clearfix">
                                        <div class="courses_show_text">Showing <span class="courses_showing">1-6</span> of
                                            <span class="courses_total">26</span> results:
                                        </div>
                    ...
                    <div class="sidebar">
                        ...
                        <div class="sidebar_section">
                            <div
                                ...
                                <div class="sidebar_banner_background" style="background-image:url(images/banner_1.jpg)">
                                </div>
